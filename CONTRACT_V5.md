...
- MLX-Audio Python lookup must prefer `WATCHBRIEF_MLX_AUDIO_PYTHON`, `watchbrief_v5/.venv-mlx/bin/python`, the project-root `.venv-mlx/bin/python`, and Hermes installed skill `.venv-mlx/bin/python` before considering the current Python executable.
